...
export const projectAPI = {
  ...
  assignDeveloper:  (id,devId)=>api.post(`/projects/${id}/assign`,{developerId:devId}),
  removeDeveloper:  (id,devId)=>api.delete(`/projects/${id}/assign/${devId}`),
  getMyProjects:    ()=>api.get('/projects/my')
};

export const documentAPI = {
  uploadDocument:   (pid,fd)=>api.post(`/documents/upload/${pid}`,fd,{headers:{'Content-Type':'multipart/form-data'}}),
